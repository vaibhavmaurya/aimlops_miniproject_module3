...
python3 bikeshare_model/train_pipeline.py --config bikeshare_model_api/config/config.yml || { echo "Failed to train model"; exit 1; }
...
cd bikeshare_model_api || { echo "Directory bikeshare_model_api does not exist"; exit 1; }
python3 -m venv venv
